...
<div>
<h2 className=" relative z-20 text-6xl my-8 max-md:mb-4  font-bold text-center font-bebas max-md:text-5xl max-sm:text-4xl tracking-wider">Why <span className='text-primary-yellow'>Choose</span> Us</h2>
